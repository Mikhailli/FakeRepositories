...
public class XmlCharacterRepository : Repository<Character>, IRepository<Character>
{
    private XmlDocument _xDoc = new XmlDocument();

    private readonly string _filename =
        "C:\\Users\\Михаил\\RiderProjects\\FakeRepositories\\WebForFakeRepositories\\xmls\\Characters.xml";
